...
ref = require('../util'), onlyIf = ref.onlyIf, isId = ref.isId, findCallback = ref.findCallback, mergePineOptions = ref.mergePineOptions, notFoundResponse = ref.notFoundResponse, noDeviceForKeyResponse = ref.noDeviceForKeyResponse, treatAsMissingDevice = ref.treatAsMissingDevice, LOCKED_STATUS_CODE = ref.LOCKED_STATUS_CODE, timeSince = ref.timeSince;
...
getDeviceModel = function(deps, opts) {
  var addExtraInfo, apiUrl, applicationModel, auth, configModel, dashboardUrl, ensureSupervisorCompatibility, exports, getDashboardUrl, getId, pine, registerDevice, request, tagsModel;
  ...
  tagsModel = once(function() {
    return require('./tags').tagsModel(deps, {
  ...
  /**
  	 ...
  	 * });
   */
  exports.tags.getAllByDevice = function(uuidOrId, options, callback) {
    if (options == null) {
      options = {};
    }
    callback = findCallback(arguments);
    return exports.get(uuidOrId, {
      ...
      return exports.tags.getAll(mergePineOptions({
        filter: {
          device: id
        }
      }, options));
