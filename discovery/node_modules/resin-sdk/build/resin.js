 ...
 */
var RESIN_SDK_HAS_SET_SHARED_OPTIONS, RESIN_SDK_HAS_USED_SHARED_OPTIONS, RESIN_SDK_SHARED_OPTIONS, ResinAuth, assign, defaults, errors, getPine, getRequest, getSdk, globalEnv, mapValues, notImplemented, sdkTemplate;
...
globalEnv = typeof window !== 'undefined' ? window : typeof self !== 'undefined' ? self : typeof global !== 'undefined' ? global : null;
...
getSdk.setSharedOptions = function(opts) {
  ...
  return globalEnv[RESIN_SDK_HAS_SET_SHARED_OPTIONS] = true;
};
