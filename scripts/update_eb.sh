...
case $CI_BRANCH in
  "staging")
    ...
    READONLY_USERNAME=$READONLY_USERNAME_STAGING \
    READONLY_PASSWORD=$READONLY_PASSWORD_STAGING \
  ...
  "production")
    ...
    READONLY_USERNAME=$READONLY_USERNAME_PRODUCTION \
    READONLY_PASSWORD=$READONLY_PASSWORD_PRODUCTION \
    RESIN_EMAIL=$RESIN_EMAIL \
    RESIN_PASS=$RESIN_PASS \
    GMAIL_ACCOUNT=$GMAIL_ACCOUNT \
    GMAIL_AUTH_TOKEN=$GMAIL_AUTH_TOKEN \
